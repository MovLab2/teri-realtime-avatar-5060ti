...
class WebRTCSyncPusher(FrameProcessor):
    def __init__(self, transport, model_pipeline, **kwargs):
        ...
        self.tts_voice = "nova"
        self.system_prompt = "You are a friendly, concise voice assistant. Keep replies short and conversational - 1 to 2 sentences max. Never use lists or formatting."
