    ...
    def generate(self, audio_embedding):
        ...
        with torch.no_grad():
            ...
            for i in range(len(self.timesteps)-1):
                ...
                end_time = time.time()
                if self.rank == 0:
                    pass  # print(f'[generate] model denoise per step: {end_time - start_time}s')
            ...
            if self.rank == 0:
                pass  # print(f'[generate] decode video frames: {end_decode_time - start_decode_time}s')
        ...
        if self.rank == 0:
            pass  # print(f'[generate] color correction: {end_color_correction_time - start_color_correction_time}s')
        ...
        if self.rank == 0:
            pass  # print(f'[generate] encode motion frames: {end_encode_time - start_encode_time}s')
